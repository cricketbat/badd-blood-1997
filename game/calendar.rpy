...
default calDate = datetime.datetime(1997, 9, 28, 12, 0, 0) #28th September 1997, midday

#The date to display, or the starting date of a time lapse.
#Current month. 1 = January, 12 = December
default displayYear = True
...
default intDelay = 1.0 #Time for which to keep showing calendar after animation.
...
#Image resources
###
image calendar_bg = "assets/calendar/bg.png" #Background image
image dayButton = "assets/calendar/gray.png" #Image representing each week day
...
label calendar(direction):
    ...
    hide calendar_bg at fade_out(0,0)
...
screen CalendarButton(day, direction, distance, posX, posY, startDelay, speed):
    frame:
        ...
        text day[0] size 30 color "#fff" font "assets/fonts/DS-DIGIB.TTF" xcenter 0.375
        add "dayButton" ypos 30
        text day[1] size 40 color "#99ccff" font "assets/fonts/DS-DIGIB.TTF" ypos 90 xcenter 0.375

screen CalendarMonth(mon):
    text mon size 72 color "#545454CC" font "assets/fonts/DS-DIGIB.TTF" xalign 0.5 at swipe_in(0, 62)

screen CalendarYear(yr):
    text yr size 48 color "#545454CC" font "assets/fonts/DS-DIGIB.TTF" at fade_in(1050, 20)
